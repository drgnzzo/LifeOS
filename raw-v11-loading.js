/* LifeOS v11.3 — raw-v11-loading.js (E3-D10)
   VERBATIM de raw-loading.js v8.42 (pantalla de arranque v9: hitos
   reales, spinner braille, ruido Metroid Prime, hud-listo + retiro de
   render-block/splash). ÚNICAS 2 líneas adaptadas: los hitos MODULOS
   e INTERFAZ apuntan a los equivalentes v11 (SEC / .nodo .card) — sin
   esto la barra colgaba hasta el tope de 8s esperando módulos v9.
   raw-loading.js original queda intacto para el v9. */
...
(function(){
  ...
  var HITOS = [
    ...
    { nombre:'MODULOS',    peso:20, texto:'Cargando modulos',      ok:function(){ return !!(window.api && window.SEC); } },          /* v11: el motor de escena sustituye a _coverflow */
    { nombre:'INTERFAZ',   peso:15, texto:'Montando interfaz',     ok:function(){ return !!document.querySelector('.nodo .card'); } },  /* v11: cards del anillo */
